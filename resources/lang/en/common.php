...
return [
    ...
    */
    ...
    'submenu'=>[
      ...
      'indexuser'=>'Danh sách người dùng',
      'createlesson'=>'Thêm bài học',
      'indexlesson'=>'Danh sách bài học',
      'createtest'=>'Thêm bài thi',
      'indextest'=>'Danh sách bài thi',
      'createbook'=>'Thêm sách',
      'indexbook'=>'Danh sách sách đọc',
      'top'=>'Thống kê top',
    ...
    'auth' => [
      ...
      'or' => 'Hoặc',
        ...
        'login_fails' => 'Sai username hoặc mật khẩu, hoặc tài khoản chưa được kích hoạt!',
        'forget_pass' => 'Quên mật khẩu?',
        'update_pass' => 'Cập nhật Mật khẩu để hoàn tất đăng ký',
        'sign_success' => 'Đăng nhập thành công',
        'change_pass' => [
            'header' => 'Cám ơn bạn đã đăng nhập tài khoản tại onlinemath',
