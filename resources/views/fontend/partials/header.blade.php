...
<link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend/imgs/logo.ico')}}" />
<link rel="image_src" href="{{asset('frontend/imgs/logo2.png')}}" />
...
<link href="{{asset('frontend/css/screen.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('frontend/css/popuplogin.css')}}" rel="stylesheet" type="text/css" />
